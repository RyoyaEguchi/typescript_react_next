  ...
  return (
    <Layout>
      <Flex padding={2} justifyContent="center" backgroundColor="primary">
        ...
        >
          <Box width="100%">
            <Text as="h1" color="white" variant="extraLarge">
              C2Cでお気に入りのアイテムを見つけよう
            </Text>
          </Box>
          <Box width="100%">
            <Text as="p" color="white" variant="mediumLarge">
              C2Cは実践的なNext.jsアプリケーション開発で使われるデモアプリです。モックサーバを利用しています.
              ソースコードは
              <Text
                as="a"
            ...
            <Text as="p" color="white" variant="mediumLarge">
              このアプリはTypescript/Next.jsで作成されており、バックエンドのモックはjson-serverが使用されています。
            </Text>
          </Box>
        </Flex>
      </Flex>
