...
describe('DelayInput', () => {
  ...
  it('should display 「入力中...」 immediately after change event occurs', () => {
  ...
  it('should display input text 1second after onChange event occurs', async () => {
    ...
    // act関数内で実行するとことにより、タイマーのコールバック中で起きる状態変更が反映されることを保証する
    await act(() => {
  ...
  it('should call onChange 1second after onChange event occcurs', async () => {
    const inputText = 'Test Input Text'
    const inputNode = screen.getByTestId('input-text') as HTMLInputElement
